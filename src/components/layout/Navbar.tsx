...
import { ArrowRightLeft, Search, User, Settings, LogOut, FileText, LayoutGrid, ClipboardList, HandCoins, PlusCircle } from "lucide-react";
import ThemeToggle from "@/components/theme/ThemeToggle";
import { useState, useRef, useEffect } from "react";

const navLinks = [
  { href: "/kategoriler", label: "Kategoriler", icon: LayoutGrid },
  { href: "/ilanlarim", label: "İlanlarım", icon: ClipboardList },
  { href: "/tekliflerim", label: "Tekliflerim", icon: HandCoins },
  { href: "/ilan-olustur", label: "İlan Oluştur", icon: PlusCircle },
];
