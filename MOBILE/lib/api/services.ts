// Backend uç noktalarını saran tip güvenli fonksiyonlar. Web ile birebir aynı;
// yalnızca dosya yükleme RN asset (uri/name/type) ile yapılır.
...
/** React Native'de seçilen görsel dosyası. */
...
export const uploadsApi = {
  image: (asset: UploadAsset) => {
    const form = new FormData();
    // RN: dosya { uri, name, type } olarak eklenir.
